...
pub struct OrderCreateCommandHandler {
    ...
    order_created_payment_request_message_publisher: Arc<dyn OrderCreatedPaymentRequestMessagePublisher>,
}
...
impl OrderCreateCommandHandler {
    pub fn new(
        order_create_helper: Arc<OrderCreateHelper>,
        order_data_mapper: Arc<OrderDataMapper>,
        order_created_payment_request_message_publisher: impl OrderCreatedPaymentRequestMessagePublisher + 'static,
    ) -> Self {
        Self {
            order_create_helper,
            order_data_mapper,
            order_created_payment_request_message_publisher: Arc::new(order_created_payment_request_message_publisher),
        }
    }
    ...
    pub async fn create_order(
        ...
        self.order_created_payment_request_message_publisher.publish(&order_created_event).await;
        Ok(self
            .order_data_mapper
